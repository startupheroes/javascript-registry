(function ($) {
  ...
  Handlers.prototype.toggle = function (e, $el) {
    var toggleClass = $el.data('toggle-attr');
  ...
  $(function () {
    ...
    $document
      .on('simple-ajax:success', Handlers.prototype.redirect)
      .on('simple-ajax:success', Handlers.prototype.fragments)
      .on('simple-ajax:success', '[data-toggle]', Handlers.prototype.toggle)
